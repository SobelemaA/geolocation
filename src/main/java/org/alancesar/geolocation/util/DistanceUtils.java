...
public class DistanceUtils {
    ...
    public static double distanceInKm(Location origin, Location destination) {
        return distanceInKm(origin.getLat(), origin.getLng(), destination.getLat(), destination.getLng());
    }

    private static double distanceInKm(double latOrig, double lngOrig, double latDest, double lngDest) {
